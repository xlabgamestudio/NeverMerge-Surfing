...
public class SixtyfourPoint : MonoBehaviour
{
    private GameObject player;

    public GameObject SixtyfourObject;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == "Player" && !dontCollide)
        {
            ...
            Instantiate(SixtyfourObject, new Vector3(player.transform.position.x, player.transform.position.y - availableY,
