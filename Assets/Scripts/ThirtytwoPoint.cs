...
public class ThirtytwoPoint : MonoBehaviour
{
    private GameObject player;

    public GameObject ThirtytwoObject;
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name == "Player" && !dontCollide)
        {
            ...
            Instantiate(ThirtytwoObject, new Vector3(player.transform.position.x, player.transform.position.y - availableY,
        ...
        else if (other.gameObject.name == "Thirtytwo Object(Clone)")
        {
